...
```console
cosign verify ghcr.io/sudo-kraken/helm-charts/prowlarr:3.1.3 --certificate-identity=https://github.com/sudo-kraken/helm-charts/.github/workflows/releases.yml@refs/heads/main --certificate-oidc-issuer=https://token.ac

...
```console
cosign verify ghcr.io/sudo-kraken/helm-charts/authentik-webfinger-proxy:0.1.0 --certificate-identity=https://github.com/sudo-kraken/helm-charts/.github/workflows/releases.yml@refs/heads/main --certificate-oidc-issuer=https://token.actions.githubusercontent.com
```
...
| app.containerPort | int | `8080` | Container listen port |

...
```console
cosign verify ghcr.io/sudo-kraken/helm-charts/finances-tracker:0.1.0 --certificate-identity=https://github.com/sudo-kraken/helm-charts/.github/workflows/releases.yml@refs/tags/v1.1.0 --certificate-oidc-issuer=https://token.actions.githubusercontent.com
```

...
```console
cosign verify ghcr.io/sudo-kraken/helm-charts/jellyfin:2.0.6 --certificate-identity=https://github.com/sudo-kraken/helm-charts/.github/workflows/release.yml@refs/heads/main --certificate-oidc-issuer=https://token.ac

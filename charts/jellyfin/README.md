...
![Version: 2.0.6](https://img.shields.io/badge/Version-2.0.6-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 10.10.7](https://img.shields.io/badge/AppVersion-10.10.7-informational?style=flat-square)
...
```console
cosign verify ghcr.io/sudo-kraken/helm-charts/jellyfin:2.0.6 --certificate-identity=https://github.com/sudo-kraken/helm-charts/.github/workflows/release.yml@refs/tags/v1.0.0 --certificate-oidc-issuer=https://token.ac
